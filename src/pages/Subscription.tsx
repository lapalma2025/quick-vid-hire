...
export default function Subscription() {
  ...
  const handleSubscribe = async (planKey: "basic" | "pro" | "boost") => {
    ...
    try {
      ...
      toast({ title: "Błąd", description: "Nie udało się otworzyć płatności", variant: "destructive" });
    } finally {
  ...
  const handleManageSubscription = async () => {
    ...
    try {
      ...
      toast({ title: "Błąd", description: "Nie udało się otworzyć portalu", variant: "destructive" });
    } finally {
    ...
    <Layout>
      <div className="container py-12 max-w-6xl">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="bg-background rounded-lg px-4 py-2">
                    ...
                    <span className="ml-2 font-bold">{remainingHighlights}</span>
                  </div>
                  {isTrusted && (
                    <div className="bg-background rounded-lg px-4 py-2 flex items-center gap-2 text-primary">
                      <Star className="h-4 w-4 fill-current" />
                      <span className="font-medium">Zaufany Profil</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {(Object.entries(SUBSCRIPTION_PLANS) as [keyof typeof SUBSCRIPTION_PLANS, typeof SUBSCRIPTION_PLANS[keyof typeof SUBSCRIPTION_PLANS]][]).map(([key, planInfo]) => {
            ...
            return (
              ...
              >
                ...
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="mt-4">
                    <span className="text-4xl font-bold">{planInfo.price} zł</span>
                ...
                <CardContent className="space-y-6">
                  ...
                  >
                    {checkoutLoading === key && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
          ...
          <Card className="mt-8">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Nie chcesz subskrypcji? Opublikuj pojedyncze ogłoszenie za jedyne 5 zł.
              </p>
