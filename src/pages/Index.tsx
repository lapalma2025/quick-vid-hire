...
export default function Index() {
	...
	return (
		<Layout>
			...
			<section
				ref={statsRef}
				className="py-8 border-y border-border/50 bg-gradient-hero"
			>
			...
			{/* Categories */}
			<section ref={categoriesRef} className="py-10 md:py-12">
				<div className="container">
			...
			{/* How it works */}
			<section ref={howItWorksRef} className="py-10 md:py-12 bg-muted/30">
				<div className="container">
					<div className="text-center mb-14">
						<h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
							Jak to działa?
			...
			{/* Features */}
			<section ref={featuresRef} className="py-10 md:py-12">
				<div className="container">
					<div className="text-center mb-14">
						<h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
							Dlaczego my?
			...
			{/* CTA */}
			<section ref={ctaRef} className="py-12 md:py-14 relative overflow-hidden">
