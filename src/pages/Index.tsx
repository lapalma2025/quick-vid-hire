...
export default function Index() {
	...
	return (
		<Layout>
			...
			{/* Categories */}
			<section ref={categoriesRef} className="py-12 md:py-14">
				<div className="container">
			...
			{/* How it works */}
			<section ref={howItWorksRef} className="py-12 md:py-14 bg-muted/30">
				<div className="container">
					<div className="text-center mb-14">
						<h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
							Jak to działa?
			...
			{/* Features */}
			<section ref={featuresRef} className="py-12 md:py-14">
				<div className="container">
					<div className="text-center mb-14">
						<h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
							Dlaczego my?
			...
			{/* CTA */}
			<section ref={ctaRef} className="py-14 md:py-16 relative overflow-hidden">
