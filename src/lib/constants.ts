...
export const WROCLAW_DISTRICTS: Record<string, { lat: number; lng: number }> = {
  "Stare Miasto": { lat: 51.1105, lng: 17.0320 },
  "Przedmieście Świdnickie": { lat: 51.0985, lng: 17.0280 },
  "Przedmieście Oławskie": { lat: 51.1010, lng: 17.0480 },
  "Plac Grunwaldzki": { lat: 51.1130, lng: 17.0600 },
  "Nadodrze": { lat: 51.1175, lng: 17.0280 },
  "Ołbin": { lat: 51.1200, lng: 17.0450 },
  "Biskupin-Sępolno-Dąbie-Bartoszowice": { lat: 51.1100, lng: 17.0850 },
  "Zalesie-Zacisze": { lat: 51.0980, lng: 17.1000 },
  "Swojczyce-Strachocin-Wojnów": { lat: 51.0900, lng: 17.1200 },
  "Brochów": { lat: 51.0880, lng: 17.0800 },
  "Księże Małe": { lat: 51.0830, lng: 17.0900 },
  "Księże Wielkie": { lat: 51.0750, lng: 17.0950 },
  "Bieńkowice": { lat: 51.0500, lng: 17.0850 },
  "Jagodno": { lat: 51.0380, lng: 17.0650 },
  "Wojszyce": { lat: 51.0500, lng: 17.0500 },
  "Ołtaszyn": { lat: 51.0450, lng: 17.0200 },
  "Klecina": { lat: 51.0550, lng: 17.0100 },
  "Krzyki-Partynice": { lat: 51.0700, lng: 17.0350 },
  "Borek": { lat: 51.0850, lng: 17.0250 },
  "Gaj": { lat: 51.0700, lng: 17.0550 },
  "Tarnogaj": { lat: 51.0720, lng: 17.0700 },
  "Huby": { lat: 51.0880, lng: 17.0450 },
  "Powstańców Śląskich": { lat: 51.0800, lng: 17.0080 },
  "Grabiszyn-Grabiszynek": { lat: 51.0900, lng: 16.9900 },
  "Oporów": { lat: 51.0750, lng: 16.9700 },
  "Nowy Dwór": { lat: 51.0620, lng: 16.9850 },
  "Żerniki": { lat: 51.0820, lng: 16.9550 },
  "Muchobór Mały": { lat: 51.0930, lng: 16.9400 },
  "Muchobór Wielki": { lat: 51.1050, lng: 16.9500 },
  "Jerzmanowo-Jarnołtów-Strachowice-Osiniec": { lat: 51.1000, lng: 16.9000 },
  "Gądów-Popowice Płd.": { lat: 51.1130, lng: 16.9700 },
  "Pilczyce-Kozanów-Popowice Płn.": { lat: 51.1300, lng: 16.9600 },
  "Leśnica": { lat: 51.1200, lng: 16.9100 },
  "Maślice": { lat: 51.1420, lng: 16.9350 },
  "Pracze Odrzańskie": { lat: 51.1550, lng: 16.9450 },
  "Osobowice-Rędzin": { lat: 51.1500, lng: 16.9750 },
  "Świniary": { lat: 51.1650, lng: 16.9850 },
  "Widawa": { lat: 51.1780, lng: 17.0200 },
  "Pawłowice": { lat: 51.1700, lng: 17.0500 },
  "Lipa Piotrowska": { lat: 51.1850, lng: 17.0800 },
  "Psie Pole-Zawidawie": { lat: 51.1600, lng: 17.0700 },
  "Sołtysowice": { lat: 51.1450, lng: 17.0550 },
  "Polanowice-Poświętne-Ligota": { lat: 51.1520, lng: 17.0150 },
  "Karłowice-Różanka": { lat: 51.1380, lng: 17.0200 },
  "Różanka": { lat: 51.1350, lng: 17.0380 },
  "Kleczków": { lat: 51.1300, lng: 17.0550 },
  "Gajowice": { lat: 51.0950, lng: 17.0100 },
  "Szczepin": { lat: 51.1100, lng: 17.0050 },
};
