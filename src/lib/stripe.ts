...
export const PREMIUM_ADDONS = {
  highlight: { name: "Wyróżnienie", price: 9, description: "Zwiększona widoczność ogłoszenia" },
  promote: { name: "Podświetlenie", price: 5, description: "Wyróżniający kolor tła" },
  urgent: { name: "PILNE", price: 4, description: "Odznaka pilnego ogłoszenia" },
  promote_24h: { name: "Promowanie 24h", price: 3, description: "Promowanie przez 24 godziny" },
} as const;
